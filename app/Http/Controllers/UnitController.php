...
class UnitController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request,[
            ...
            'name.required'         => 'Offer&Coupuns name field is required',
        ]);
        Unit::newUnit($request);
        return back()->with('message', 'Offer&Coupuns is created successfully.');
    }
    ...
    public function show(Unit $unit)
    {
        ...
        return back()->with('message','Offer&Coupuns is updated');
    }
