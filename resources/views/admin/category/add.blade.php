                    ...
                    <div class="border p-3 rounded">
                        ...
                        <form action="{{ route('category.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-12 mt-4 mb-3">
                                <div class="multi-box d-flex gap-5">  <!-- Added gap-3 for spacing -->
                                    <label class="d-flex align-items-center gap-3">
                                        <input class="form-check-input" name="top" type="checkbox" value="top" id="flexCheckDefault">Top
                                    </label>
                                    <label class="d-flex align-items-center gap-3">
                                        <input class="form-check-input" name="mid" type="checkbox" value="mid" id="flexCheckDefault">Middle
                                    </label>
                                    <label class="d-flex align-items-center gap-3">
                                        <input class="form-check-input" name="bottom" type="checkbox" value="bottom" id="flexCheckDefault">bottom
                                    </label>
                                </div>
                            </div>
