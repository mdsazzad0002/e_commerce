    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Flavor</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="col">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title"> Flavor Form</h3>
                </div>
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('color.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{ old('name') }}" name="name" id="name" placeholder="flavor Name" type="text"/>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" id="description" placeholder="Flavor Description" ></textarea>
                            </div>
                        </div>
                        ...
                        <button class="btn btn-primary rounded-0 float-end" type="submit">Create New Flavor</button>
                    </form>
                </div>
            </div>
        </div>
