    ...
    <div class="col-6">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ route('custom-flower.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                        ...
                        <div class="col-md-9">
                            <div class="form-check">
                                ...
                                <div class="row mb-3 align-items-center">
                                    <!-- Checkbox -->
                                    <div class="col-4">
                                        <input class="form-check-input" type="checkbox" name="colors[]" value="{{ $item->id }}" id="flexCheckChecked{{ $item->id }}">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <input type="text" name="prices[{{ $item->id }}]" class="form-control" id="price{{ $item->id }}">
                                    </div>
                                </div>
                                @endforeach
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="">
                                    <input class="form-control" value="{{ old('name') }}" name="name" id="name"
                                        placeholder="flower name" type="text" />
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('flower.color.store') }}" method="post"
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="">
                                    <input class="form-control" value="{{ old('name') }}" name="name" id="name"
                                        placeholder="flower color" type="text" />
                        ...
                        <table id="example3x" class="table table-bordered text-nowrap border-bottom">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('flower.color.delete',$item->id) }}" method="post">
                                            @csrf
