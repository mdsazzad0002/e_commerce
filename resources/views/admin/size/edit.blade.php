...
@section('body')
    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Pound/Pcs</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit Pound/pcs</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="col">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">Edit Pound/Pcs Form</h3>
                </div>
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('size.update',$size->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{ $size->name }}" name="name" id="name" placeholder="Pounds/pcs Name" type="text"/>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" id="description" placeholder="Pounds/pcs Description" >{{ $size->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <button class="btn btn-primary rounded-0 float-end" type="submit">Update Pounds/pcs Info</button>
                    </form>
                </div>
            </div>
        </div>
