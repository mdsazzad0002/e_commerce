    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Offer&Coupuns</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('unit.update',$unit->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{ $unit->name }}" name="name" id="name" placeholder="Offer&Coupuns Name" type="text"/>
                        ...
                        <button class="btn btn-primary rounded-0 float-end" type="submit">Update Offer&Coupuns Info</button>
                    </form>
                </div>
            </div>
        </div>
